...
bg-white/10 backdrop-blur-lg border border-white/5 
p-4 w-[240px] shadow-lg rounded-lg">
  ...
  <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
    ...
    <h1 className="font-serif italic text-[#EAE7DF] 
      text-[40px] md:text-[70px] lg:text-[90px] leading-tight">
...
<section className="bg-black text-white py-16 md:py-24 px-6 md:px-16">
  ...
  <div className="grid md:grid-cols-2 gap-12 items-center">
    ...
    <div className="relative">
      ...
      <div className="
        md:absolute md:left-[-80px] md:top-1/2 md:-translate-y-1/2
        bg-black p-6 md:p-10 mt-6 md:mt-0
        max-w-md shadow-xl
      ">
